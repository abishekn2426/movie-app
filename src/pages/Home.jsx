  ...
  return (
    <div className="p-4 pt-16">
      <input
        ...
        className="p-2 w-3/4 md:w-1/2 border rounded border-gray-700 bg-purple-600 bg-opacity-60 backdrop-blur-md text-white fixed top-16 left-1/2 transform -translate-x-1/2 z-10"
